...
```json
{"animal":"walrus","level":"trace","msg":"I see the most detail",
...
```text
time="2015-03-26T01:27:38-04:00" level=trace msg="I see the most detail" animal=walrus number=6
...
Logrus has 7 logging levels: Trace, Debug, Info, Warning, Error, Fatal and Panic.

```go
log.Trace("Some very low level information")
